...
struct Inventory
{
	...
	/// \brief Map of speciesSku <-> minimum threshold; minimum threshold indicates when restock of a species is needed.
	std::unordered_map<std::string, int> lowThresholdBySku; 
};
