...
public:
    ...
    /**
     * @brief Applies balanced fertilization for Mediterranean plants
     * @param plant Reference to the Mediterranean plant to be fertilized
     */
    void fertilize(Plant& plant) override;

    /**
     * @brief Applies insecticide spraying behavior for Mediterranean plants
     * @param plant Reference to the Mediterranean plant to be sprayed
     */
